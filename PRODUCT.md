...
**Primary audiences (all equally weighted):**
...
- **Language**: English only across all public-facing properties. Neutral tone, avoiding buzzwords.
  - **Vibe**: Terminal aesthetic (Hub), Hacker-Builder (Freebuilder/Freeware), Luxury Editorial (Freewriter Lab).
...
| `freebuilder.html` (freebuilder.co) | Dark hacker / builder energy + amber accent | `#080808` bg, amber `#F5A623`, neon green `#00E87A` | Bebas Neue + JetBrains Mono + DM Sans |
| `freeware.html` (freeware.lab) | Dark hacker / neon green | `#080808` bg, neon green `#00E87A` | Bebas Neue + JetBrains Mono + DM Sans |
| `freewriter.html` (freewriter.lab) | Light luxury editorial | `#FAF6EE` cream, navy `#1B1F3B`, gold `#C4983A` | Cormorant Garamond + Jost |
...
4. **Builder-first aesthetics.** Prefer terminal metaphors, monospace type, code-like structures, and dark backgrounds on the hub. Reserve polish and luxury for Freewriter Lab. Reserve energy and boldness for Freebuilder and Freeware.
